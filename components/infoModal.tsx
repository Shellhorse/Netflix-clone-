...
const InfoModal: React.FC<IInfoModalProps> = ({
    ...
    return (
        <>
        <div className=" absolute z-50 trasition duration-300 bg-black/80 flex justify-center items-center overflow-x-hidden overflow-y-auto inset-0">
            <div className="relative w-auto mx-auto max-w-3xl rounded-md overflow-hidden">
                <div className={`${isVisible ? "scale-100" : "scale-0"} transform duration-300 relative flex-auto bg-zinc-900 drop-shadow-md`}>
                    <div className="relative h-96">
                        <video className="w-full brightness-[50%] object-cover h-full" autoPlay muted loop poster={data.thumbnailUrl} src={data?.videoUrl}></video>
